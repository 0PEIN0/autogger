...
AL_PROJECT_ROOT_FOLDER="$SYSTEM_ROOT_GIT_REPO_FOLDER/$AL_REPO_NAME"
...
AL_INIT_POSTGRES_DB_FILE_PATH="$AL_PROJECT_ROOT_FOLDER/scripts/$AL_INIT_DB_FILE_NAME"
AL_INIT_POSTGRES_DB_USER_PASSWORD_FILE_PATH="$AL_PROJECT_ROOT_FOLDER/scripts/$AL_POSTGRES_USER_PASSWORD_RESET_FILE_NAME"
AL_INIT_DATA_LOAD_PYTHON_FILE_PATH="$AL_PROJECT_ROOT_FOLDER/scripts/$AL_INIT_DATA_LOAD_PYTHON_FILE_NAME"
