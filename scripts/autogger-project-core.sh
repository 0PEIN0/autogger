...
alias ${AL_PROJECT_NAME_UNDERSCORE}_ve_installs="djangoDefaultSetup \"$SYSTEM_ROOT_GIT_REPO_FOLDER/$AL_REPO_NAME\" $AL_INIT_REQUIREMENTS_FILE_NAME $AL_PROJECT_NAME_UNDERSCORE"
